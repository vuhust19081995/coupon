...
/**
 * A generic Listing Builder to construct a Listing object associated with user.
 */
class APP_User_Listing_Builder extends APP_Listing_Builder {

	/**
	 * Set up listing meta object.
	 */
	public function set_meta_object() {
		$meta_object = new APP_Listing_User_Meta_Object();
	...
	public function add_modules() {
		...
		$this->listing->add_module( 'form_fields_box',   'APP_Listing_User_Metabox', array( 'form', '__admin__' ) );
