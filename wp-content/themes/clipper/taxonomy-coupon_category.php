			...
			<div class="content-box">
				...
				<div class="box-holder">
					...
					<div class="head no-bg">
						...
						<a class="rss-link" href="<?php echo get_term_feed_link( $term->term_id, $taxonomy ); ?>" rel="nofollow" target="_blank" title="<?php esc_attr_e( 'Coupon Category RSS', APP_TD ); ?>"><i class="fa fa-rss-square" aria-hidden="true"></i></a>
						<h1 class="archive"><?php printf( __( 'Coupons in the "%s" category', APP_TD ), $term->name ); ?></h1>
